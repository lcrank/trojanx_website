  ...
  return (
    <>
      <style>{`
        ...
        @media(max-width:768px) { .hw-grid { grid-template-columns: 1fr; } .page-banner { padding: 7rem 0 3rem; } .hw-page { padding: 3rem 0; } }
        @media(max-width:480px) { .hw-card { padding: 1.25rem; } }
      `}</style>
