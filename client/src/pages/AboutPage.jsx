  ...
  return (
    <>
      <style>{`
        ...
        @media(max-width:768px) { .about-block .row, .choose-block .row { grid-template-columns: 1fr; } .process-grid { grid-template-columns: 1fr; } .stats-grid { grid-template-columns: repeat(2,1fr); } .page-banner { padding: 7rem 0 3rem; } .cta-block { padding: 3rem 1.5rem; } }
        @media(max-width:480px) { .about-block, .choose-block, .process-block, .stats-block { padding: 3rem 0; } }
      `}</style>
