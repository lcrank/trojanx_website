  ...
  return (
    <>
      <style>{`
        ...
        @media(max-width:768px) { .blog-grid { grid-template-columns: 1fr; } .page-banner { padding: 7rem 0 3rem; } .blog-page { padding: 3rem 0; } }
        @media(max-width:480px) { .blog-card .content { padding: 1rem; } }
      `}</style>
